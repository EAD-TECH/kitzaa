...
export type AdminCreateUserInput = z.infer<typeof adminInviteUserSchema>;
...
const updateUserShape = z.object({
  username: z
    .string()
    .trim()
  ...
  location: z
    .object({
      ...
      district: z.string().trim().min(2).max(50).optional(),
...
// İLK KURULUM (SETUP ACCOUNT) ŞEMASI
/* update den mıras aldım ozellıklerı  */
export const setupAccountSchema = updateUserShape
  .extend({
    newPassword: z
      .string()
      .regex(
