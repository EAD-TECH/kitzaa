  ...
  return (
    <div className="flex items-center justify-between px-3 tablet:px-5 desktop:px-8 bg-card/40 border-b border-border sticky backdrop-blur-sm">
      ...
      <Link href="/home" className="flex items-center">
        <Image className="w-34 py-2 tablet:py-1 " src={logo} alt="Kitzaa logo" />
      </Link>
        ...
        {!currentUser
          ...
          <div className="">
            <DropdownMenu open={menuOpen} onOpenChange={setMenuOpen}>
              <DropdownMenuTrigger render={<Button variant="ghost" size="icon" className="tablet:rounded-full cursor-pointer size-10 hover:bg-transparent aria-expanded:bg-transparent tablet:hover:bg-muted tablet:aria-expanded:bg-muted">
